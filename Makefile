...
# Template: app
# Command: /Users/hubohao/Qt5.7.0/5.7/clang_64/bin/qmake -o Makefile tpapp_server_manage.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = tpapp_server_manage1.0.0
...
Makefile: tpapp_server_manage.pro ../../Qt5.7.0/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt5.7.0/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt5.7.0/5.7/clang_64/mkspecs/qdevice.pri \
		../../Qt5.7.0/5.7/clang_64/mkspecs/features/device_config.prf \
		../../Qt5.7.0/5.7/clang_64/mkspecs/common/unix.conf \
		../../Qt5.7.0/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -o Makefile tpapp_server_manage.pro
...
tpapp_server_manage.app/Contents/PkgInfo: 
	@test -d tpapp_server_manage.app/Contents || mkdir -p tpapp_server_manage.app/Contents
	@$(DEL_FILE) tpapp_server_manage.app/Contents/PkgInfo
	@echo "APPL????" > tpapp_server_manage.app/Contents/PkgInfo
tpapp_server_manage.app/Contents/Resources/empty.lproj: 
	@test -d tpapp_server_manage.app/Contents/Resources || mkdir -p tpapp_server_manage.app/Contents/Resources
	@touch tpapp_server_manage.app/Contents/Resources/empty.lproj
	
tpapp_server_manage.app/Contents/Info.plist: 
	@test -d tpapp_server_manage.app/Contents || mkdir -p tpapp_server_manage.app/Contents
	@$(DEL_FILE) tpapp_server_manage.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.fl.tpapp-server-manage,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,tpapp_server_manage,g" -e "s,@LIBRARY@,tpapp_server_manage,g" -e "s,@TYPEINFO@,????,g" ../../Qt5.7.0/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >tpapp_server_manage.app/Contents/Info.plist

all: Makefile \
		tpapp_server_manage.app/Contents/PkgInfo \
		tpapp_server_manage.app/Contents/Resources/empty.lproj \
		tpapp_server_manage.app/Contents/Info.plist $(TARGET)
...
distclean: clean 
	-$(DEL_FILE) -r tpapp_server_manage.app

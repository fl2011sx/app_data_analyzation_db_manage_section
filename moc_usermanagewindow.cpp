...
QT_INIT_METAOBJECT const QMetaObject UserManageWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UserManageWindow.data,
      qt_meta_data_UserManageWindow,  qt_static_metacall, nullptr, nullptr}
};
...
void *UserManageWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AfterActionDelegate"))
        return static_cast< AfterActionDelegate*>(this);
